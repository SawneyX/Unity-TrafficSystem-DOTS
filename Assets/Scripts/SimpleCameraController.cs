...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        class CameraState
        {
            ...
            public void TranslateZoom(Vector3 translation)
            {
        ...
        Vector3 GetInputTranslationDirection()
        {
            ...
            if (Input.GetAxis("Mouse ScrollWheel") > 0 && builder.type != 3 && builder.type != 4 && !EventSystem.current.IsPointerOverGameObject())
            {
        ...
        void Update()
        {
            ...
            */
            ...
            {
                m_TargetCameraState.TranslateZoom(translation);
            }

            else m_TargetCameraState.Translate(translation);
